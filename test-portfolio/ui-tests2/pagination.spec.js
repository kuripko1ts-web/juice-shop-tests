...
describe('Pagination Тести - Наявність та базові перевірки', () => {
  test('@pagination @positive Сценарій Перевірка наявності пагінатора', async ({ page }) => {
  ...
  test('@pagination @positive Сценарій Перевірка тексту діапазону сторінок', async ({ page }) => {
...
describe('Pagination Тести - Зміна кількості елементів на сторінці', () => {
  test('@pagination @functional Сценарій Зміна кількості елементів на сторінці на 15', async ({ page }) => {
  ...
  test('@pagination @functional Сценарій Зміна кількості елементів на сторінці на 45', async ({ page }) => {
...
describe('Pagination Тести - Навігація між сторінками', () => {
  test('@pagination @functional Сценарій Перевірка стану кнопки Next Page', async ({ page }) => {
  ...
  test('@pagination @functional Сценарій Перевірка стану кнопки Previous Page', async ({ page }) => {
    ...
    console.log('✅ Кнопка Previous Page неактивна на першій сторінці (як очікувалося)');
  });

  test('@pagination @functional Сценарій Навігація на наступну сторінку', async ({ page }) => {
  ...
  test('@pagination @functional Сценарій Навігація на попередню сторінку', async ({ page }) => {
    ...
    if (isNextEnabled) {
      ...
      console.log('⚠️ Неможливо перейти на наступну сторінку для тестування навігації назад');
    }
  });
});

describe('Pagination Тести - Комплексні сценарії', () => {
  test('@pagination @complex Сценарій Повний цикл навігації по сторінках', async ({ page }) => {
    ...
    while (await searchPage.isNextPageEnabled()) {
      ...
      console.log(`📋 Діапазон після навігації ${navigationCount}: ${currentRange}`);
    }
